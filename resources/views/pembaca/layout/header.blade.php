...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="assets/img/favicons/ICON.png">
    ...
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/favicons/ICON.ico">
    <link rel="manifest" href="assets/img/favicons/manifest.json">
    <meta name="msapplication-TileImage" content="assets/img/favicons/mstile-150x150.png">
    <meta name="theme-color" content="#ffffff">

    <link href="{{ asset('Zakat/public/assets/css/theme.css') }}" rel="stylesheet" />
