    ...
    <main class="main" id="top">
      ...
      <section class="pt-5 pt-md-9" id="menyalurkan">
        ...
        <div class="container">
          ...
          <div class="mb-7 text-center">
            ...
            <h3 class="fs-xl-10 fs-lg-8 fs-7 fw-bold font-cursive text-capitalize">Infaq Shodaqoh </h3>
          </div>
                      ...
                      <table class="table text-nowrap mb-0 align-middle">
                        <thead class="text-dark fs-5">
                          <tr>
                            ...
                            <th class="border-bottom-0">
                              <h6 class="fw-semibold mb-0">Saldo Akhir</h6>
                            </th>
                            <th class="border-bottom-0">
                              <h6 class="fw-semibold mb-0">Status Infaq</h6>
                            </th>
                          </tr>
                        </thead>
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="border-bottom-0">
                              ...
                              <span class="badge bg-secondary rounded-0 fw-semibold">Selasa, 1 Januari 2024</span>
                              </div>                         
                            </td>
                            <td class="border-bottom-0">
                              <p class="mb-0 fw-normal">Rp. 50,000,000</p>
                            </td>
                            <td class="border-bottom-0">
                              <p class="mb-0 fw-normal">Rp. 10,000,000</p>
                            </td>
                            <td class="border-bottom-0">
                              <p class="mb-0 fw-normal">Rp. 40,000,000</p>
                            </td>
                            <td class="border-bottom-0 d-flex align-items-center gap-2"> 
                              <span class="badge bg-success rounded-0 fw-semibold">Tersimpan Dalam Kas Masjid</span>
      ...
      <!-- <section class="pt-5 pt-md-9" id="menyalurkan">
        ...
        <div class="container">
          ...
          <div class="mb-7 text-center">
            <h5 class="text-secondary">Dokumentasi</h5>
            <h3 class="fs-xl-10 fs-lg-8 fs-7 fw-bold font-cursive text-capitalize">Infaq Shodaqoh</h3>
          </div>
