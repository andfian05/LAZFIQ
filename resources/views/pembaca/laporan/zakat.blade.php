      ...
      <section class="pt-5 pt-md-9" id="menyalurkan">
        ...
        <div class="container">
          ...
          <div class="mb-7 text-center">
            ...
            <h3 class="fs-xl-10 fs-lg-8 fs-7 fw-bold font-cursive text-capitalize">Zakat Fitrah & Profesi</h3>
          </div>
                      ...
                      <table class="table text-nowrap mb-0 align-middle">
                        <thead class="text-dark fs-5">
                          <tr>
                            ...
                            <th class="border-bottom-0">
                              <h6 class="fw-semibold mb-0">Total Zakat (Uang)</h6>
                            </th>
                            <th class="border-bottom-0">
                              <h6 class="fw-semibold mb-0">Total Zakat (Beras)</h6>
                            </th>
                            <th class="border-bottom-0">
                              <h6 class="fw-semibold mb-0">Total Mustahiq Zakat</h6>
                            </th>
                            <th class="border-bottom-0">
                              <h6 class="fw-semibold mb-0">Status Zakat</h6>
                            </th>
                          </tr>
                        </thead>
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="border-bottom-0">
                              <p class="mb-0 fw-normal">185 Kilogram</p>
                            </td>
                            <td class="border-bottom-0">
                          ...
                          <tr>
                            ...
                            <td class="border-bottom-0">
                              <p class="mb-0 fw-normal">200 Kilogram</p>
                            </td>
                            <td class="border-bottom-0">
