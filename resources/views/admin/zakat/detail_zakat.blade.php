                                ...
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="" aria-describedby=""
                                            value="{{ \Carbon\Carbon::parse($postZakat->tanggal_pz)->locale('id')->isoFormat('D MMMM YYYY') }}"
                                            disabled>
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label">Total Zakat (Uang)</label>
                                        <input type="text" class="form-control" id="" aria-describedby=""
                                            value="Rp. {{ number_format($postZakat->zakat_uang, 2, ',', '.') }}" disabled>
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label">Total Zakat (Beras)</label>
                                        <input type="text" class="form-control" id="" aria-describedby=""
                                            value="{{ $postZakat->zakat_beras }} Kg" disabled>
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label">Total Mustahiq Zakat</label>
                                        <input type="text" class="form-control" id="" aria-describedby=""
                                            value="{{ $postZakat->mustahiq_pz }} Orang" disabled>
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label">Status Zakat</label>
                                        <select class="form-control" name="" id="" disabled>
                                            @if ($postZakat->status_pz === 'disalurkan')
                                                <option value="disalurkan" selected>Disalurkan untuk Umat</option>
                                            @else
                                                <option value="menunggu" selected>Pengumpulan zakat</option>
                                            @endif
                                        </select>
                                    </div>
                                </form>
