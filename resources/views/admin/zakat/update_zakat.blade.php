            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('postZakat.update', $postZakat->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="tanggal"
                                            ...
                                            aria-describedby="" value="{{ $postZakat->tanggal_pz }}">
                                        @error('tanggal')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="jzUang"
                                            ...
                                            aria-describedby="" value="{{ $postZakat->zakat_uang }}">
                                        @error('jzUang')
                                            <div class="form-control-muted">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="jzBeras"
                                            ...
                                            aria-describedby="" value="{{ $postZakat->zakat_beras }}">
                                        @error('jzBeras')
                                            <div class="form-control-muted">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="mustahiq"
                                            ...
                                            aria-describedby="" value="{{ $postZakat->mustahiq_pz }}">
                                        @error('mustahiq')
                                            <div class="form-control-muted">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control @error('statusZakat') is-invalid @enderror"
                                            ...
                                            <option value="menunggu"
                                                {{ old('statusZakat', $postZakat->status_pz ?? '') == 'menunggu' ? 'selected' : '' }}>
                                                Pengumpulan zakat</option>
                                            <option value="disalurkan"
                                                {{ old('statusZakat', $postZakat->status_pz ?? '') == 'disalurkan' ? 'selected' : '' }}>
