        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              ...
              <a href="/tambah_zakat" class="btn btn-primary mb-3">Tambah Data</a>
                    ...
                    <table class="table">
                                ...
                                <tbody class="table-group-divider">
                                        ...
                                        <tr>
                                            ...
                                            <td data-title="TZ (Uang)">Rp. 40,000,000</td>
                                            <td data-title="TZ (Beras)">185 Kilogram</td>
                                            ...
                                            <th class="d-flex justify-content-center">
                                                <a class="btn btn-secondary btn-sm me-2"
                                                    href="/detail_zakat"> Melihat</a>
                                                <a class="btn btn-warning btn-sm me-2"
                                                    href="/update_zakat"> Update</a>
                                        ...
                                        <tr>
                                            ...
                                            <td data-title="TZ (Uang)">Rp. 50,000,000</td>
                                            <td data-title="TZ (Beras)">200 Kilogram</td>
                                            <!-- <td data-title="Saldo Akhir">Rp. 40,000,000</td> -->
                                            <!-- <td data-title="Status Akhir">Tersimpan Dalam Kas Masjid</td> -->
                                            <th class="d-flex justify-content-center">
                                                <a class="btn btn-secondary btn-sm me-2"
                                                    href="/detail_zakat"> Melihat</a>
                                                <a class="btn btn-warning btn-sm me-2"
                                                    href="/update_zakat"><i class="fa-solid fa-pencil"></i> Update</a>
                                                <a class="btn btn-danger btn-sm me-2"
