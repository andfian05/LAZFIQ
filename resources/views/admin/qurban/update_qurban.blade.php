        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              ...
              <a href="/form_qurban" class="btn btn-outline-primary m-1 mb-3 ">Kembali Halaman</a>
              <div class="card">
                <div class="card-body">
                  <form>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="" id="" value="" >
                            ...
                            <option value="menunggu">Pengumpulan Zakat</option>
                            <option value="disalurkan">Disalurkan Untuk Umat</option>
                 
                        </select>
                    </div><br>
                    
                    <button type="submit" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">Perbaiki Data</button>
