...
@section('content')
        ...
        <div class="container-fluid">
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold mb-4">Laporan Qurban</h5>
                            <a href="{{ route('postQurban.create') }}" class="btn btn-primary mb-3">
                                Tambah Data
                            </a>
                            <a href="{{ route('postQurban.exportExcel') }}" class="btn btn-success mb-3">
                                Excel
                            </a>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Hewan Qurban (Sapi)</th>
                                            <th scope="col">Hewan Qurban (Kambing)</th>
                                ...
                                <div class="d-flex justify-content-between align-items-center py-3">
                                    ...
                                    <nav>
                                        <ul class="pagination mb-0">
                                            ...
                                            @else
                                                <li class="page-item">
                                                    <a class="page-link" href="{{ $qurbans->previousPageUrl() }}">Prev</a>
                                                </li>
                                            @endif
                                            ...
                                            @if ($qurbans->hasMorePages())
                                                <li class="page-item">
                                                    <a class="page-link" href="{{ $qurbans->nextPageUrl() }}">Next</a>
                                                </li>
                                            @else
                                                <li class="page-item disabled">
            ...
            <div class="py-6 px-6 text-center">
                <p class="mb-0 fs-4">Design and Developed by <a href="https://www.linkedin.com/in/fianfi/" target="_blank"
                        class="pe-1 text-primary text-decoration-underline">AndFat</a></p>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        deleteModal.addEventListener('show.bs.modal', function(event) {
            ...
            var qurbanId = button.getAttribute('data-id'); // Ambil data-id

            // Update action form dengan ID yang dipilih
            var form = deleteModal.querySelector('#deleteForm');
            form.action = '/post-qurban/' + qurbanId;
        });
    </script>
    </div>
@endsection
