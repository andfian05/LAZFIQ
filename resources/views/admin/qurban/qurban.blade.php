        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              ...
              <a href="/tambah_qurban" class="btn btn-primary mb-3">Tambah Data</a>
              <a href="" class="btn btn-success mb-3">Excel</a>
                    ...
                    <table class="table">
                                ...
                                <tbody class="table-group-divider">
                                        ...
                                        <tr>
                                            ...
                                            <td data-title="HQ (Sapi)">10 Ekor</td>
                                            <td data-title="HQ (Kambing)">15 Ekor</td>
                                            ...
                                            <th class="d-flex justify-content-center">
                                                <a class="btn btn-secondary btn-sm me-2"
                                                    href="/detail_qurban"> Melihat</a>
                                                <a class="btn btn-warning btn-sm me-2"
                                                    href="/update_qurban"> Update</a>
                                        ...
                                        <tr>
                                            <td scope="row" data-title="No" class="text-center">2</td>
                                            <td data-title="Tanggal">Selasa, 2 Januari 2024</td>
                                            <td data-title="HQ (Sapi)">20 Ekor</td>
                                            <td data-title="HQ (Kambing)">17 Ekor</td>
                                            <!-- <td data-title="Saldo Akhir">Rp. 40,000,000</td> -->
                                            <!-- <td data-title="Status Akhir">Tersimpan Dalam Kas Masjid</td> -->
                                            <th class="d-flex justify-content-center">
                                                <a class="btn btn-secondary btn-sm me-2"
                                                    href="/detail_qurban"> Melihat</a>
                                                <a class="btn btn-warning btn-sm me-2"
                                                    href="/update_qurban"><i class="fa-solid fa-pencil"></i> Update</a>
                                                <a class="btn btn-danger btn-sm me-2"
                                                    href=""><i class="fa-solid fa-pencil"></i> Hapus</a>
