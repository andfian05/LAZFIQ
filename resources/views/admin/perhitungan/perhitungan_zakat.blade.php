                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form>
                                    <a href="{{ route('countZakat.index') }}" class="btn btn-outline-primary">
                                        Mengecek Data
                                    </a>
                                </form>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('countZakat.store') }}" method="POST" id="form1" name="form1">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="muzakki"
                                            class="form-control @error('muzakki') is-invalid @enderror" id=""
                                            aria-describedby="">
                                        @error('muzakki')
                                            <div class="form-control-muted">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="kb_muzakki" class="form-control @error('kb_muzakki') is-invalid @enderror" cols="3"
                                            rows="3"></textarea>
                                        @error('kb_muzakki')
                                            <div class="form-control-muted">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control @error('jenisZakat') is-invalid @enderror"
                                            name="jenisZakat" id="kategori" value="" onclick="tampilkan()">
                                            <option value="">--- Pilih ---</option>
                                            @foreach ($jenisZakat as $key => $value)
                                        ...
                                        function tampilkan() {
                                            ...
                                            if (pesan == "beras") {
                                                p_kontainer.innerHTML = `
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-12">
                                                            <input type="number" name="zBeras" 
                                                                class="form-control @error('zBeras') is-invalid @enderror" id="" aria-describedby="">
                                                        </div>
                                                    </div>
                                                    @error('zBeras')
                                                        <div class="form-control-muted">{{ $message }}</div>
                                                ...
                                                p_kontainer.innerHTML = `
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-12">
                                                            <input type="number" name="zUang" 
                                                                class="form-control @error('zUang') is-invalid @enderror" id="" aria-describedby="">
                                                        </div>
                                                    </div>
                                                    @error('zUang')
                                                        <div class="form-control-muted">{{ $message }}</div>
