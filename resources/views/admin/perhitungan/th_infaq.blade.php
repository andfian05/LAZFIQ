...
@section('content')
                                        ...
                                        @forelse ($infaqs as $infaq)
                                            <tr>
                                                ...
                                                <td data-title="Tanggal">
                                                    {{ \Carbon\Carbon::parse($infaq->tanggal_ci)->locale('id')->translatedFormat('l, d F Y') }}
                                                </td>
                                                <td data-title="Waktu">
                                                    {{ str_replace(':', '.', \Carbon\Carbon::parse($infaq->waktu_ci)->format('H:i')) }}
                                                    WIB
                                                </td>
                                                <td data-title="Saldo Akhir">
                                                    Rp. {{ number_format($infaq->saldo_akhir_ci, 2, ',', '.') }}
                                                </td>
                                                <th class="d-flex justify-content-center">
                                                    <a class="btn btn-secondary btn-sm me-2"
                                                        href="{{ route('countInfaq.show', $infaq->id) }}">
                                                        Melihat
                                                    </a>
    ...
    <script type="text/javascript">
        ...
        deleteModal.addEventListener('show.bs.modal', function(event) {
            ...
            form.action = '/count-infaq/' + infaqId;
        });
    </script>
    </div>
@endsection