        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              ...
              <a href="/cek_infaq" class="btn btn-outline-primary m-1 mb-3 ">Kembali Halaman</a>
              <div class="card">
                <div class="card-body">
                  <form>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label">Bukti Pengeluaran <sup>* Jika Ada</sup></label>
                        <input type="file" class="form-control" id="" aria-describedby=""><br>
                        <!-- <img src="{{asset('Gp/assets/img/portfolio/portfolio-1.jpg')}}" class="boder-1" width="200" height="200"> -->
                        <div class="col-md-4">
                        <div class="card">
                            <img src="{{asset('Gp/assets/img/portfolio/portfolio-1.jpg')}}" class="card-img-top" alt="...">
                            <div class="card-body">
                            
                            <p class="card-text">Senin, 09 Agustus 2024 : 10.00 WIB</p>
