...
@section('content')
        ...
        <div class="container-fluid">
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold mb-4">Laporan Perhitungan Qurban</h5>
                                        ...
                                        @forelse ($qurbans as $qurban)
                                            <tr>
                                                ...
                                                <td data-title="Tanggal">
                                                    {{ \Carbon\Carbon::parse($qurban->tanggal_cq)->locale('id')->translatedFormat('l, d F Y') }}
                                                </td>
                                                <td data-title="Kategori">
                                                    {{ $qurban->kategori_qurban }}
                                                </td>
                                                <td data-title="Pemberi?">
                                                    {{ $qurban->nama_yg_qurban }}
                                                </td>
                                                <th class="d-flex justify-content-center">
                                                    <a class="btn btn-secondary btn-sm me-2"
                                                        href="{{ route('countQurban.show', $qurban->id) }}">
                                                        Melihat
                                                    </a>
    ...
    <script type="text/javascript">
        ...
        deleteModal.addEventListener('show.bs.modal', function(event) {
            ...
            form.action = '/count-qurban/' + qurbanId;
        });
    </script>
    </div>
@endsection
