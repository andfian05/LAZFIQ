                    ...
                    <table class="table">
                                ...
                                <tbody class="table-group-divider">
                                        ...
                                        <tr>
                                            ...
                                            <td data-title="Kategori">Sapi</td>
                                            <td data-title="Pemberi?">Mumun Bin Muzakar, Masum Bin Mumun, Fagy Bin Mumet, Joe Bin Toe, Erik Bin Endr</td>
                                            <!-- <td data-title="Status Akhir">Tersimpan Dalam Kas Masjid</td> -->
                                            <th class="d-flex justify-content-center">
                                                <a class="btn btn-secondary btn-sm me-2"
                                                    href="/detail_cek_qurban"> Melihat</a>
