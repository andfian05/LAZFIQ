...
@section('content')
        ...
        <div class="container-fluid">
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold mb-4">Laporan Perhitungan Zakat</h5>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Nama Muzakki Pertama</th>
                                        ...
                                        @forelse ($zakats as $zakat)
                                            <tr>
                                                ...
                                                <td data-title="Tanggal">
                                                    {{ \Carbon\Carbon::parse($zakat->tanggal_cz)->locale('id')->translatedFormat('l, d F Y') }}
                                                </td>
                                                <td data-title="Waktu">
                                                    {{ str_replace(':', '.', \Carbon\Carbon::parse($zakat->waktu_cz)->format('H:i')) }}
                                                    WIB
                                                </td>
                                                <td data-title="Nama Muzakki Pertama">
                                                    {{ $zakat->muzakki_pertama }}
                                                </td>
                                                <th class="d-flex justify-content-center">
                                                    <a class="btn btn-secondary btn-sm me-2"
                                                        href="{{ route('countZakat.show', $zakat->id) }}">
                                                        Melihat
                                                    </a>
    ...
    <script type="text/javascript">
        ...
        deleteModal.addEventListener('show.bs.modal', function(event) {
            ...
            form.action = '/count-zakat/' + zakatId;
        });
    </script>
    </div>
@endsection
